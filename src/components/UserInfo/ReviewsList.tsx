...
const ReviewsList = () => {
    let {getAllReviews,reviews}=UseUser();
    let {deleteReview,getProduct,productInfo}=UseSpecificProduct()
  ...
  {reviews?.length?    
  <div className="items-center grid grid-cols-1 md:grid-cols-2 gap-6 mb-96 mt-14 w-full max-w-7xl ">
        {reviews?.map((review) => (
          <div key={review._id} className="flex flex-col cursor-pointer border rounded py-7 px-8" >
          ...
          <div className="flex flex-row mb-2">
            ...
            <div className="flex flex-row gap-2 ">
                 <img src="../../../src/assets/Frame 568.svg" alt="delete" className="cursor-pointer" onClick={()=>handleDelete(review._id)}/>
                  <img
                    src="../../../src/assets/Fill Eye.svg"
                    alt="eye"
                    className="cursor-pointer"
                    onClick={()=>handleReview(review.productId)}
                  />
      ...
      </div>:  <div className="flex flex-row justify-center align-middle mb-96 text-4xl font-semibold">
